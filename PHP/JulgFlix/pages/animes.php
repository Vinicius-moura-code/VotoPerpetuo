  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-3">
        <div id="resposta">
          ...
          if (isset($_POST['Enviar']) && !empty($_POST['titulo'])) {
            ...
            $inserir = mysqli_query($connection, "insert into animes(titulo, sinopse, genero, datal, ondassistir, pa, numtemp) values('$titulo','$sinopse', '$genero', '$datal', '$ondassistir', '$pa', '$numtemp') ");
            if ($inserir == true) {
      ...
      <div id="conteudo" class="col-md-6">
        <form action="animes.php" method="post">
              ...
              <div class="modal-body">
                <table class='table table-striped' id='tableUsuario'>
                  ...
                  if (isset($_POST['show'])) {
                    include("../server/connection.php");
                    $db = mysqli_select_db($connection, DB_DATABASE);
                    $resultado = mysqli_query($connection, "select * from animes order by id_user;");
